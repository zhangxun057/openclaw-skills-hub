...
const SKILLS = {
  ...
  '开发 & 部署': [
    ...
    { name: 'skill-creator', desc: 'Create or update AgentSkills', icon: '🛠️', source: '官方' },
    { name: 'gateway-restart', desc: 'OpenClaw Gateway 服务重启', icon: '🔄', source: '原创' },
  ],
  '系统 & 工具': [
    { name: 'capability-evolver', desc: 'A self-evolution engine for AI agents', icon: '🧬', source: '原创' },
    { name: 'task-monitor', desc: 'Real-time web dashboard for OpenClaw', icon: '📈', source: '原创' },
    { name: 'conversation-save', desc: '对话存档技能', icon: '💾', source: '原创' },
    { name: 'feishu', desc: '飞书集成工具', icon: '📋', source: '社区' },
