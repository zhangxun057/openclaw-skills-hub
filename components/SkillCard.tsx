  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow p-6">
      ...
      <p className="text-gray-600 text-sm mb-4 line-clamp-2">
        {skill.description || '点击查看详情'}
      </p>

      <div className="flex gap-2">
        <a
          href={`/skill/${encodeURIComponent(skill.path.replace('.md', ''))}`}
          className="flex-1 bg-orange-50 hover:bg-orange-100 text-orange-600 text-sm font-medium py-2 px-4 rounded-lg transition text-center"
        >
          查看详情
        </a>
